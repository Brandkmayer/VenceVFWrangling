...
st_write(FullFenceShape,paste0(path,"Shapefiles/",Herd,"_",Fence,"_FF.shp"));st_write(FinalVFSo,paste0(path,"Shapefiles/",Herd,"_",Fence,"_Sound.shp"));st_write(FinalVFSh,paste0(path,"Shapefiles/",Herd,"_",Fence,"_Shock.shp"))
